...
parser.add_argument('--from_ckpt', type=str,
                    default=pdir + "/data/checkpoints/Melody-G2.pth",
...
from stateless import sigmoid_first, get_bigwig_filepaths, check_args, config_model_loss_fn, \
    ...
    get_pre_process_func, get_embedding
...
from check_utils import check_runs_return_multiple_pic_dict_batched_calc_total, clean_seq_ndarray, \
    get_aucs_and_accs_aggregated, get_corrs_aggregated
